...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padded relative overflow-hidden text-center" style={{ padding: '64px 48px' }}>
      ...
      <div ref={ref} className="reveal relative z-10" style={{ maxWidth: 700, margin: '0 auto' }}>
        <div className="font-display font-black leading-none mb-8" style={{
          ...
          <span style={{ color: 'var(--neon-pink)', WebkitTextStroke: 0, textShadow: '0 0 60px rgba(255,45,120,0.5)' }}>
            {t('contact.headlineAccent')}
          </span>
          {t('contact.headlinePost')}
        </div>
        <p className="text-lg leading-relaxed mb-12" style={{ color: '#8a8aaa' }}>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          {links.map(l => (
            <a key={l.href} href={l.href} target={l.href.startsWith('mailto') ? undefined : '_blank'} rel="noreferrer"
              ...
              style={{ color: '#8a8aaa', border: '1px solid rgba(255,255,255,0.07)', background: '#12121a' }}
              ...
              onMouseLeave={e => { e.currentTarget.style.color = '#8a8aaa'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.background = '#12121a'; e.currentTarget.style.transform = 'none' }}>
              {l.icon}{l.label}
            </a>
          ))}
        </div>
